...
function Modal2() {
  return (
    <div className="w-[25rem]  h-[28rem] shadow-md bg-white  rounded-2xl overflow-hidden text-sm">
      <div className=" flex justify-between p-2 bg-slate-200">
        <h1 className=" font-semibold">See my available: today</h1>
        <Mic />
      </div>
      <div className=" space-y-3 p-2">
        <h1 className=" text-lg font-bold">Available until 1 PM</h1>
        ...
        <div className=" bg-slate-100 rounded-2xl  grid grid-cols-5 gap-6  ">
         ...
         <h1 className=" text-slate-400">11 AM</h1>
          ...
          <div className=" h-8 flex justify-center text-slate-400">
          <h1 >3 AM</h1>
          </div>
         </div>
          <div className=" col-span-4 space-y-3 ">
            ...
            <div className=" relative h-8 flex justify-center">
                ...
                <div className=" flex justify-center items-center h-8 bg-blue-200">
              ...
              <div className=" h-12 flex justify-center items-center gap-6 bg-slate-300 border-4">
        ...
        <div className=" flex  space-x-3 border-t pt-6">
          <button className=" text-xs font-semibold text-slate-600 bg-slate-200 rounded-3xl py-2 px-3">
            Create Event
          </button>
          <button className=" text-xs font-semibold text-slate-600 bg-slate-200 rounded-3xl py-2 px-3">
            Edit Event
