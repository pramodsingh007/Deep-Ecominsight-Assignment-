      ...
      <div className=" space-y-4 p-4">
        ...
        <div className=" bg-slate-100 rounded-2xl  grid grid-cols-5 gap-6  ">
         ...
         <h1 className=" text-slate-400">11 AM</h1>
          ...
          <div className=" h-6 flex justify-center text-slate-400">
          <h1 >3 AM</h1>
          </div>
         </div>
          <div className=" col-span-4 space-y-3 ">
            ...
            <div className=" relative h-8 flex justify-center">
                ...
                <div className=" flex justify-center items-center h-6 bg-blue-200">
        ...
        <div className=" flex  space-x-2 border-t pt-3">
          <button className=" font-semibold text-slate-600 bg-slate-200 hover:bg-slate-300 rounded-3xl py-3 px-3">
            Create Event
          </button>
          <button className=" font-semibold text-slate-600 bg-slate-200 hover:bg-slate-300 rounded-3xl py-3 px-3">
            Edit Event
